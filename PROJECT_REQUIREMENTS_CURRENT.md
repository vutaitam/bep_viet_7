...
Đã có portrait Cụ Ông. Chưa tích hợp portrait riêng cho Bác Tâm, Cô Lan, John và các NPC khác. `PROMPTS_ART_v1.12.md` là nguồn prompt cho asset art tiếp theo.
...
4. Tích hợp art portrait NPC hoặc polish UI nếu asset đủ tốt.
