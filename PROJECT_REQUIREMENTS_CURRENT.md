...
- Version trong game: **Demo v1.11.03.2 (NPC Portraits)**.
...
Kế hoạch đồ họa mới theo yêu cầu người dùng nằm ở `GRAPHICS_PLAN_demo_v1.11.03.2.md`. Tên bản đang triển khai là **Demo v1.11.03.2**.
...
Trạng thái hiện tại: Bếp Việt Demo v1.11.03.2 (NPC Portraits), vanilla HTML/CSS/JS, đã tách 6 file runtime: index.html, css/styles.css, js/data.js, js/state.js, js/game.js, js/screens.js.
