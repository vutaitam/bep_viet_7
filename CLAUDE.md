...
## 🛠️ KIẾN TRÚC CODE (Demo v1.11.03.2 — runtime 6-file)
...
## HANDOFF HIỆN TẠI - HƯỚNG Demo v1.11.03.2+
...
- Version: **🎨 Demo v1.11.03.2 (NPC Portraits)** (3 NPC portrait WebP + round 5 balance fixes + SVG portrait + modular refactor).
...
```text
Đọc PROJECT_REQUIREMENTS_CURRENT.md, README.md, GRAPHICS_PLAN_demo_v1.11.03.2.md, phần handoff mới nhất trong CLAUDE.md và các file runtime liên quan. Tiếp tục từ Demo v1.11.03.2.
