...
**Phiên bản hiện tại**: 🎨 **Demo v1.11.03 (NPC Portraits)** (3 NPC portrait WebP + balance fixes round 5 + SVG Cụ Ông portrait + modular refactor)
...
> Lưu ý 2026-04-30: phần này là quyết định scope cũ. Bản hiện tại đã mở rộng lên 10 món, 5 đồ uống gameplay thật, 21 NPC, 15 level, festival/gallery và refactor nhiều file. Ưu tiên trạng thái mới trong `PROJECT_REQUIREMENTS_CURRENT.md`.
...
## 🛠️ KIẾN TRÚC CODE (Demo v1.11.03 — runtime 6-file)
...
**Phiên bản đang chạy: 🎨 Demo v1.11.03 (NPC Portraits)**
...
- ✅ Hội đồng chuyên gia round 5 đã được áp vào beta v1.11.04.1
...
## HANDOFF HIỆN TẠI - HƯỚNG Demo v1.11.03+
...
- File chơi chính: `index.html` (chỉ HTML markup) + `css/styles.css` + 4 file JS trong `js/`.
- Version: **🎨 Demo v1.11.03 (NPC Portraits)** (3 NPC portrait WebP + round 5 balance fixes + SVG portrait + modular refactor).
...
```text
Đọc PROJECT_REQUIREMENTS_CURRENT.md, README.md, GRAPHICS_PLAN_demo_v1.11.03.md, phần handoff mới nhất trong CLAUDE.md và các file runtime liên quan. Tiếp tục từ Demo v1.11.03.
