...
const INGREDIENTS = {
  bun:{name:'Bún tươi',emoji:'🍜',image:'assets/icons/ingredients/bun.svg'},
  suon:{name:'Sườn heo',emoji:'🥩',image:'assets/icons/ingredients/suon.svg'},
  doc_mung:{name:'Dọc mùng',emoji:'🌿',image:'assets/icons/ingredients/doc_mung.svg',special:true},
  ca_chua:{name:'Cà chua',emoji:'🍅',image:'assets/icons/ingredients/ca_chua.svg'},
  banh_mi_loaf:{name:'Bánh mì',emoji:'🥖',image:'assets/icons/ingredients/banh_mi_loaf.svg'},
  pate:{name:'Pate',emoji:'🟫',image:'assets/icons/ingredients/pate.svg'},
  thit_nguoi:{name:'Thịt nguội',emoji:'🥓',image:'assets/icons/ingredients/thit_nguoi.svg'},
  rau_song:{name:'Rau sống',emoji:'🥬',image:'assets/icons/ingredients/rau_song.svg'},
  cha:{name:'Chả (cần nướng)',emoji:'🍖',image:'assets/icons/ingredients/cha.svg',needsGrill:true},
  nuoc_cham:{name:'Nước chấm',emoji:'🥣',image:'assets/icons/ingredients/nuoc_cham.svg'},
  mi_quang_noodle:{name:'Mì Quảng',emoji:'🍝',image:'assets/icons/ingredients/mi_quang_noodle.svg'},
  thit_heo:{name:'Thịt heo',emoji:'🥩',image:'assets/icons/ingredients/thit_heo.svg'},
  tom:{name:'Tôm',emoji:'🦐',image:'assets/icons/ingredients/tom.svg'},
  hu_tieu_noodle:{name:'Hủ tiếu',emoji:'🍜',image:'assets/icons/ingredients/hu_tieu_noodle.svg'},
  nuoc_dung:{name:'Nước dùng',emoji:'🫕',image:'assets/icons/ingredients/nuoc_dung.svg'},
  pho_noodle:{name:'Bánh phở',emoji:'🍜',image:'assets/icons/ingredients/pho_noodle.svg'},
  thit_bo:{name:'Thịt bò',emoji:'🥩',image:'assets/icons/ingredients/thit_bo.svg'},
  rau_thom:{name:'Rau thơm',emoji:'🌿',image:'assets/icons/ingredients/rau_thom.svg'},
  sa_te:{name:'Sa tế',emoji:'🌶️',image:'assets/icons/ingredients/sa_te.svg'},
  com_tam_rice:{name:'Cơm tấm',emoji:'🍚',image:'assets/icons/ingredients/com_tam_rice.svg'},
  banh_trang:{name:'Bánh tráng',emoji:'🫓',image:'assets/icons/ingredients/banh_trang.svg'},
  rieu_cua:{name:'Riêu cua',emoji:'🦀',image:'assets/icons/ingredients/rieu_cua.svg'},
  ga_xe:{name:'Gà xé',emoji:'🍗',image:'assets/icons/ingredients/ga_xe.svg'},
  // ── Drink ingredients ──
  tra_la:{name:'Trà',emoji:'🍵',image:'assets/icons/ingredients/tra_la.svg',isDrink:true},
  da:{name:'Đá viên',emoji:'🧊',image:'assets/icons/ingredients/da.svg',isDrink:true},
  tac:{name:'Quả tắc',emoji:'🍋',image:'assets/icons/ingredients/tac.svg',isDrink:true},
  mia:{name:'Mía',emoji:'🎋',image:'assets/icons/ingredients/mia.svg',isDrink:true},
  ca_phe_bot:{name:'Cà phê',emoji:'☕',image:'assets/icons/ingredients/ca_phe_bot.svg',isDrink:true},
  sua_dac:{name:'Sữa đặc',emoji:'🥛',image:'assets/icons/ingredients/sua_dac.svg',isDrink:true},
  rau_ma_la:{name:'Lá rau má',emoji:'🌿',image:'assets/icons/ingredients/rau_ma_la.svg',isDrink:true}
};
...
const NPCS = {
  ...
  sinh_vien:{name:'Minh',emoji:'🎒',portrait:'assets/portraits/sinh-vien.svg',favorite:'banh_mi',trait:'Sinh viên xa nhà, thích món rẻ mà ấm bụng',patience:58,tip:1.1,isRegular:false,drink:'tra_da',
  ...
  food_blogger:{name:'Linh Review',emoji:'📱',portrait:'assets/portraits/food-blogger.svg',favorite:'bun_bo_hue',trait:'Khách bí ẩn: quay review cho quán',patience:55,tip:1.65,isRegular:false,isMystery:true,drink:'ca_phe_sua_da',
  ...
  viet_kieu:{name:'Chú Phúc',emoji:'🧳',portrait:'assets/portraits/viet-kieu.svg',favorite:'pho_bo',trait:'Khách bí ẩn: Việt kiều tìm lại vị quê',patience:85,tip:1.6,isRegular:false,isMystery:true,drink:'tra_da',
  ...
  khach_im_lang:{name:'Khách im lặng',emoji:'🎩',portrait:'assets/portraits/khach-im-lang.svg',favorite:null,trait:'Khách bí ẩn: chỉ gọi món bằng gợi ý',patience:65,tip:1.8,isRegular:false,isMystery:true,drink:'rau_ma',
  ...
  // Boss NPCs
  tuan_pb:{name:'Nhà phê bình Tuấn',emoji:'🧐',portrait:'assets/portraits/tuan-pb.svg',favorite:'bun_doc_mung',trait:'Nhà phê bình ẩm thực',patience:50,tip:0,isRegular:false,isBoss:true,failOnLeave:true,
  ...
  khang:{name:'Đầu bếp Khang',emoji:'👨‍🍳',portrait:'assets/portraits/khang.svg',favorite:'bun_cha',trait:'Đối thủ cũ của Cụ Ông',patience:45,tip:0,isRegular:false,isBoss:true,
    quotes:{arrive:'Hm. Xem cậu nấu có bằng Cụ không nhé.',happy:'Được rồi. Tôi công nhận tài năng.',angry:'Thua kém Cụ rồi cậu ơi.'}},
  iron_chef:{name:'Iron Chef Việt',emoji:'🏆',portrait:'assets/portraits/iron-chef.svg',favorite:'bun_doc_mung',trait:'Đầu bếp số 1 cả nước',patience:50,tip:3.0,isRegular:false,isBoss:true,failOnLeave:true,
